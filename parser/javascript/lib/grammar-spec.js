...
(function() {
  ...
  */
  ...
  GrammarSpec = (function() {
    ...
    //   | [x:10000-x:10FFFF]
    GrammarSpec.prototype.c_printable.num = 1;

    // [002]
    // nb-json ::=
    //   x:9 | [x:20-x:10FFFF]
    GrammarSpec.prototype.nb_json.num = 2;

    // [003]
    // c-byte-order-mark ::=
    //   x:FEFF
    GrammarSpec.prototype.c_byte_order_mark.num = 3;

    // [004]
    // c-sequence-entry ::=
    //   '-'
    GrammarSpec.prototype.c_sequence_entry.num = 4;

    // [005]
    // c-mapping-key ::=
    //   '?'
    GrammarSpec.prototype.c_mapping_key.num = 5;

    // [006]
    // c-mapping-value ::=
    //   ':'
    GrammarSpec.prototype.c_mapping_value.num = 6;

    // [007]
    // c-collect-entry ::=
    //   ','
    GrammarSpec.prototype.c_collect_entry.num = 7;

    // [008]
    // c-sequence-start ::=
    //   '['
    GrammarSpec.prototype.c_sequence_start.num = 8;

    // [009]
    // c-sequence-end ::=
    //   ']'
    GrammarSpec.prototype.c_sequence_end.num = 9;

    // [010]
    // c-mapping-start ::=
    //   '{'
    GrammarSpec.prototype.c_mapping_start.num = 10;

    // [011]
    // c-mapping-end ::=
    //   '}'
    GrammarSpec.prototype.c_mapping_end.num = 11;

    // [012]
    // c-comment ::=
    //   '#'
    GrammarSpec.prototype.c_comment.num = 12;

    // [013]
    // c-anchor ::=
    //   '&'
    GrammarSpec.prototype.c_anchor.num = 13;

    // [014]
    // c-alias ::=
    //   '*'
    GrammarSpec.prototype.c_alias.num = 14;

    // [015]
    // c-tag ::=
    //   '!'
    GrammarSpec.prototype.c_tag.num = 15;

    // [016]
    // c-literal ::=
    //   '|'
    GrammarSpec.prototype.c_literal.num = 16;

    // [017]
    // c-folded ::=
    //   '>'
    GrammarSpec.prototype.c_folded.num = 17;

    // [018]
    // c-single-quote ::=
    //   '''
    GrammarSpec.prototype.c_single_quote.num = 18;

    // [019]
    // c-double-quote ::=
    //   '"'
    GrammarSpec.prototype.c_double_quote.num = 19;

    // [020]
    // c-directive ::=
    //   '%'
    GrammarSpec.prototype.c_directive.num = 20;

    // [021]
    // c-reserved ::=
    //   '@' | '`'
    GrammarSpec.prototype.c_reserved.num = 21;
    ...
    //   | '#' | '&' | '*' | '!' | '|' | '>' | ''' | '"'
    //   | '%' | '@' | '`'
    GrammarSpec.prototype.c_indicator.num = 22;

    // [023]
    // c-flow-indicator ::=
    //   ',' | '[' | ']' | '{' | '}'
    GrammarSpec.prototype.c_flow_indicator.num = 23;

    // [024]
    // b-line-feed ::=
    //   x:A
    GrammarSpec.prototype.b_line_feed.num = 24;

    // [025]
    // b-carriage-return ::=
    //   x:D
    GrammarSpec.prototype.b_carriage_return.num = 25;

    // [026]
    // b-char ::=
    //   b-line-feed | b-carriage-return
    GrammarSpec.prototype.b_char.num = 26;

    // [027]
    // nb-char ::=
    //   c-printable - b-char - c-byte-order-mark
    GrammarSpec.prototype.nb_char.num = 27;
    ...
    //   | b-carriage-return
    //   | b-line-feed
    GrammarSpec.prototype.b_break.num = 28;

    // [029]
    // b-as-line-feed ::=
    //   b-break
    GrammarSpec.prototype.b_as_line_feed.num = 29;

    // [030]
    // b-non-content ::=
    //   b-break
    GrammarSpec.prototype.b_non_content.num = 30;

    // [031]
    // s-space ::=
    //   x:20
    GrammarSpec.prototype.s_space.num = 31;

    // [032]
    // s-tab ::=
    //   x:9
    GrammarSpec.prototype.s_tab.num = 32;

    // [033]
    // s-white ::=
    //   s-space | s-tab
    GrammarSpec.prototype.s_white.num = 33;

    // [034]
    // ns-char ::=
    //   nb-char - s-white
    GrammarSpec.prototype.ns_char.num = 34;

    // [035]
    // ns-dec-digit ::=
    //   [x:30-x:39]
    GrammarSpec.prototype.ns_dec_digit.num = 35;

    // [036]
    // ns-hex-digit ::=
    //   ns-dec-digit
    //   | [x:41-x:46] | [x:61-x:66]
    GrammarSpec.prototype.ns_hex_digit.num = 36;

    // [037]
    // ns-ascii-letter ::=
    //   [x:41-x:5A] | [x:61-x:7A]
    GrammarSpec.prototype.ns_ascii_letter.num = 37;

    // [038]
    // ns-word-char ::=
    //   ns-dec-digit | ns-ascii-letter | '-'
    GrammarSpec.prototype.ns_word_char.num = 38;
    ...
    //   | ';' | '/' | '?' | ':' | '@' | '&' | '=' | '+' | '$' | ','
    //   | '_' | '.' | '!' | '~' | '*' | ''' | '(' | ')' | '[' | ']'
    GrammarSpec.prototype.ns_uri_char.num = 39;

    // [040]
    // ns-tag-char ::=
    //   ns-uri-char - '!' - c-flow-indicator
    GrammarSpec.prototype.ns_tag_char.num = 40;

    // [041]
    // c-escape ::=
    //   '\'
    GrammarSpec.prototype.c_escape.num = 41;

    // [042]
    // ns-esc-null ::=
    //   '0'
    GrammarSpec.prototype.ns_esc_null.num = 42;

    // [043]
    // ns-esc-bell ::=
    //   'a'
    GrammarSpec.prototype.ns_esc_bell.num = 43;

    // [044]
    // ns-esc-backspace ::=
    //   'b'
    GrammarSpec.prototype.ns_esc_backspace.num = 44;

    // [045]
    // ns-esc-horizontal-tab ::=
    //   't' | x:9
    GrammarSpec.prototype.ns_esc_horizontal_tab.num = 45;

    // [046]
    // ns-esc-line-feed ::=
    //   'n'
    GrammarSpec.prototype.ns_esc_line_feed.num = 46;

    // [047]
    // ns-esc-vertical-tab ::=
    //   'v'
    GrammarSpec.prototype.ns_esc_vertical_tab.num = 47;

    // [048]
    // ns-esc-form-feed ::=
    //   'f'
    GrammarSpec.prototype.ns_esc_form_feed.num = 48;

    // [049]
    // ns-esc-carriage-return ::=
    //   'r'
    GrammarSpec.prototype.ns_esc_carriage_return.num = 49;

    // [050]
    // ns-esc-escape ::=
    //   'e'
    GrammarSpec.prototype.ns_esc_escape.num = 50;

    // [051]
    // ns-esc-space ::=
    //   x:20
    GrammarSpec.prototype.ns_esc_space.num = 51;

    // [052]
    // ns-esc-double-quote ::=
    //   '"'
    GrammarSpec.prototype.ns_esc_double_quote.num = 52;

    // [053]
    // ns-esc-slash ::=
    //   '/'
    GrammarSpec.prototype.ns_esc_slash.num = 53;

    // [054]
    // ns-esc-backslash ::=
    //   '\'
    GrammarSpec.prototype.ns_esc_backslash.num = 54;

    // [055]
    // ns-esc-next-line ::=
    //   'N'
    GrammarSpec.prototype.ns_esc_next_line.num = 55;

    // [056]
    // ns-esc-non-breaking-space ::=
    //   '_'
    GrammarSpec.prototype.ns_esc_non_breaking_space.num = 56;

    // [057]
    // ns-esc-line-separator ::=
    //   'L'
    GrammarSpec.prototype.ns_esc_line_separator.num = 57;

    // [058]
    // ns-esc-paragraph-separator ::=
    //   'P'
    GrammarSpec.prototype.ns_esc_paragraph_separator.num = 58;

    // [059]
    // ns-esc-8-bit ::=
    //   'x'
    //   ( ns-hex-digit{2} )
    GrammarSpec.prototype.ns_esc_8_bit.num = 59;

    // [060]
    // ns-esc-16-bit ::=
    //   'u'
    //   ( ns-hex-digit{4} )
    GrammarSpec.prototype.ns_esc_16_bit.num = 60;

    // [061]
    // ns-esc-32-bit ::=
    //   'U'
    //   ( ns-hex-digit{8} )
    GrammarSpec.prototype.ns_esc_32_bit.num = 61;
    ...
    GrammarSpec.prototype.c_ns_esc_char.num = 62;

    // [063]
    // s-indent(n) ::=
    //   s-space{n}
    GrammarSpec.prototype.s_indent.num = 63;

    // [064]
    // s-indent(<n) ::=
    //   s-space{m} <where_m_<_n>
    GrammarSpec.prototype.s_indent_lt.num = 64;

    // [065]
    // s-indent(<=n) ::=
    //   s-space{m} <where_m_<=_n>
    GrammarSpec.prototype.s_indent_le.num = 65;

    // [066]
    // s-separate-in-line ::=
    //   s-white+ | <start_of_line>
    GrammarSpec.prototype.s_separate_in_line.num = 66;
    ...
    GrammarSpec.prototype.s_line_prefix.num = 67;

    // [068]
    // s-block-line-prefix(n) ::=
    //   s-indent(n)
    GrammarSpec.prototype.s_block_line_prefix.num = 68;

    // [069]
    // s-flow-line-prefix(n) ::=
    //   s-indent(n)
    //   s-separate-in-line?
    GrammarSpec.prototype.s_flow_line_prefix.num = 69;

    // [070]
    // l-empty(n,c) ::=
    //   ( s-line-prefix(n,c) | s-indent(<n) )
    //   b-as-line-feed
    GrammarSpec.prototype.l_empty.num = 70;

    // [071]
    // b-l-trimmed(n,c) ::=
    //   b-non-content l-empty(n,c)+
    GrammarSpec.prototype.b_l_trimmed.num = 71;

    // [072]
    // b-as-space ::=
    //   b-break
    GrammarSpec.prototype.b_as_space.num = 72;

    // [073]
    // b-l-folded(n,c) ::=
    //   b-l-trimmed(n,c) | b-as-space
    GrammarSpec.prototype.b_l_folded.num = 73;
    ...
    //   s-flow-line-prefix(n)
    GrammarSpec.prototype.s_flow_folded.num = 74;

    // [075]
    // c-nb-comment-text ::=
    //   '#' nb-char*
    GrammarSpec.prototype.c_nb_comment_text.num = 75;

    // [076]
    // b-comment ::=
    //   b-non-content | <end_of_file>
    GrammarSpec.prototype.b_comment.num = 76;
    ...
    //   c-nb-comment-text? )?
    //   b-comment
    GrammarSpec.prototype.s_b_comment.num = 77;

    // [078]
    // l-comment ::=
    //   s-separate-in-line c-nb-comment-text?
    //   b-comment
    GrammarSpec.prototype.l_comment.num = 78;

    // [079]
    // s-l-comments ::=
    //   ( s-b-comment | <start_of_line> )
    //   l-comment*
    GrammarSpec.prototype.s_l_comments.num = 79;
    ...
    GrammarSpec.prototype.s_separate.num = 80;
    ...
    //   s-flow-line-prefix(n) )
    //   | s-separate-in-line
    GrammarSpec.prototype.s_separate_lines.num = 81;
    ...
    //   s-l-comments
    GrammarSpec.prototype.l_directive.num = 82;

    // [083]
    // ns-reserved-directive ::=
    //   ns-directive-name
    //   ( s-separate-in-line ns-directive-parameter )*
    GrammarSpec.prototype.ns_reserved_directive.num = 83;

    // [084]
    // ns-directive-name ::=
    //   ns-char+
    GrammarSpec.prototype.ns_directive_name.num = 84;

    // [085]
    // ns-directive-parameter ::=
    //   ns-char+
    GrammarSpec.prototype.ns_directive_parameter.num = 85;

    // [086]
    // ns-yaml-directive ::=
    //   'Y' 'A' 'M' 'L'
    //   s-separate-in-line ns-yaml-version
    GrammarSpec.prototype.ns_yaml_directive.num = 86;

    // [087]
    // ns-yaml-version ::=
    //   ns-dec-digit+ '.' ns-dec-digit+
    GrammarSpec.prototype.ns_yaml_version.num = 87;
    ...
    GrammarSpec.prototype.ns_tag_directive.num = 88;
    ...
    GrammarSpec.prototype.c_tag_handle.num = 89;

    // [090]
    // c-primary-tag-handle ::=
    //   '!'
    GrammarSpec.prototype.c_primary_tag_handle.num = 90;

    // [091]
    // c-secondary-tag-handle ::=
    //   '!' '!'
    GrammarSpec.prototype.c_secondary_tag_handle.num = 91;

    // [092]
    // c-named-tag-handle ::=
    //   '!' ns-word-char+ '!'
    GrammarSpec.prototype.c_named_tag_handle.num = 92;

    // [093]
    // ns-tag-prefix ::=
    //   c-ns-local-tag-prefix | ns-global-tag-prefix
    GrammarSpec.prototype.ns_tag_prefix.num = 93;

    // [094]
    // c-ns-local-tag-prefix ::=
    //   '!' ns-uri-char*
    GrammarSpec.prototype.c_ns_local_tag_prefix.num = 94;

    // [095]
    // ns-global-tag-prefix ::=
    //   ns-tag-char ns-uri-char*
    GrammarSpec.prototype.ns_global_tag_prefix.num = 95;
    ...
    GrammarSpec.prototype.c_ns_properties.num = 96;
    ...
    //   | c-ns-shorthand-tag
    //   | c-non-specific-tag
    GrammarSpec.prototype.c_ns_tag_property.num = 97;

    // [098]
    // c-verbatim-tag ::=
    //   '!' '<' ns-uri-char+ '>'
    GrammarSpec.prototype.c_verbatim_tag.num = 98;

    // [099]
    // c-ns-shorthand-tag ::=
    //   c-tag-handle ns-tag-char+
    GrammarSpec.prototype.c_ns_shorthand_tag.num = 99;

    // [100]
    // c-non-specific-tag ::=
    //   '!'
    GrammarSpec.prototype.c_non_specific_tag.num = 100;

    // [101]
    // c-ns-anchor-property ::=
    //   '&' ns-anchor-name
    GrammarSpec.prototype.c_ns_anchor_property.num = 101;

    // [102]
    // ns-anchor-char ::=
    //   ns-char - c-flow-indicator
    GrammarSpec.prototype.ns_anchor_char.num = 102;

    // [103]
    // ns-anchor-name ::=
    //   ns-anchor-char+
    GrammarSpec.prototype.ns_anchor_name.num = 103;

    // [104]
    // c-ns-alias-node ::=
    //   '*' ns-anchor-name
    GrammarSpec.prototype.c_ns_alias_node.num = 104;

    // [105]
    // e-scalar ::=
    //   <empty>
    GrammarSpec.prototype.e_scalar.num = 105;

    // [106]
    // e-node ::=
    //   e-scalar
    GrammarSpec.prototype.e_node.num = 106;

    // [107]
    // nb-double-char ::=
    //   c-ns-esc-char | ( nb-json - '\' - '"' )
    GrammarSpec.prototype.nb_double_char.num = 107;

    // [108]
    // ns-double-char ::=
    //   nb-double-char - s-white
    GrammarSpec.prototype.ns_double_char.num = 108;

    // [109]
    // c-double-quoted(n,c) ::=
    //   '"' nb-double-text(n,c)
    //   '"'
    GrammarSpec.prototype.c_double_quoted.num = 109;
    ...
    GrammarSpec.prototype.nb_double_text.num = 110;

    // [111]
    // nb-double-one-line ::=
    //   nb-double-char*
    GrammarSpec.prototype.nb_double_one_line.num = 111;
    ...
    GrammarSpec.prototype.s_double_escaped.num = 112;

    // [113]
    // s-double-break(n) ::=
    //   s-double-escaped(n) | s-flow-folded(n)
    GrammarSpec.prototype.s_double_break.num = 113;

    // [114]
    // nb-ns-double-in-line ::=
    //   ( s-white* ns-double-char )*
    GrammarSpec.prototype.nb_ns_double_in_line.num = 114;
    ...
    GrammarSpec.prototype.s_double_next_line.num = 115;

    // [116]
    // nb-double-multi-line(n) ::=
    //   nb-ns-double-in-line
    //   ( s-double-next-line(n) | s-white* )
    GrammarSpec.prototype.nb_double_multi_line.num = 116;

    // [117]
    // c-quoted-quote ::=
    //   ''' '''
    GrammarSpec.prototype.c_quoted_quote.num = 117;

    // [118]
    // nb-single-char ::=
    //   c-quoted-quote | ( nb-json - ''' )
    GrammarSpec.prototype.nb_single_char.num = 118;

    // [119]
    // ns-single-char ::=
    //   nb-single-char - s-white
    GrammarSpec.prototype.ns_single_char.num = 119;

    // [120]
    // c-single-quoted(n,c) ::=
    //   ''' nb-single-text(n,c)
    //   '''
    GrammarSpec.prototype.c_single_quoted.num = 120;
    ...
    GrammarSpec.prototype.nb_single_text.num = 121;

    // [122]
    // nb-single-one-line ::=
    //   nb-single-char*
    GrammarSpec.prototype.nb_single_one_line.num = 122;

    // [123]
    // nb-ns-single-in-line ::=
    //   ( s-white* ns-single-char )*
    GrammarSpec.prototype.nb_ns_single_in_line.num = 123;
    ...
    GrammarSpec.prototype.s_single_next_line.num = 124;

    // [125]
    // nb-single-multi-line(n) ::=
    //   nb-ns-single-in-line
    //   ( s-single-next-line(n) | s-white* )
    GrammarSpec.prototype.nb_single_multi_line.num = 125;
    ...
    GrammarSpec.prototype.ns_plain_first.num = 126;
    ...
    GrammarSpec.prototype.ns_plain_safe.num = 127;

    // [128]
    // ns-plain-safe-out ::=
    //   ns-char
    GrammarSpec.prototype.ns_plain_safe_out.num = 128;

    // [129]
    // ns-plain-safe-in ::=
    //   ns-char - c-flow-indicator
    GrammarSpec.prototype.ns_plain_safe_in.num = 129;
    ...
    //   | ( ':' <followed_by_an_ns-plain-safe(c)> )
    GrammarSpec.prototype.ns_plain_char.num = 130;
    ...
    GrammarSpec.prototype.ns_plain.num = 131;

    // [132]
    // nb-ns-plain-in-line(c) ::=
    //   ( s-white*
    //   ns-plain-char(c) )*
    GrammarSpec.prototype.nb_ns_plain_in_line.num = 132;

    // [133]
    // ns-plain-one-line(c) ::=
    //   ns-plain-first(c)
    //   nb-ns-plain-in-line(c)
    GrammarSpec.prototype.ns_plain_one_line.num = 133;

    // [134]
    // s-ns-plain-next-line(n,c) ::=
    //   s-flow-folded(n)
    //   ns-plain-char(c) nb-ns-plain-in-line(c)
    GrammarSpec.prototype.s_ns_plain_next_line.num = 134;

    // [135]
    // ns-plain-multi-line(n,c) ::=
    //   ns-plain-one-line(c)
    //   s-ns-plain-next-line(n,c)*
    GrammarSpec.prototype.ns_plain_multi_line.num = 135;
    ...
    //   ( c = flow-key => flow-key )
    GrammarSpec.prototype.in_flow.num = 136;

    // [137]
    // c-flow-sequence(n,c) ::=
    //   '[' s-separate(n,c)?
    //   ns-s-flow-seq-entries(n,in-flow(c))? ']'
    GrammarSpec.prototype.c_flow_sequence.num = 137;
    ...
    //   ( ',' s-separate(n,c)?
    //   ns-s-flow-seq-entries(n,c)? )?
    GrammarSpec.prototype.ns_s_flow_seq_entries.num = 138;

    // [139]
    // ns-flow-seq-entry(n,c) ::=
    //   ns-flow-pair(n,c) | ns-flow-node(n,c)
    GrammarSpec.prototype.ns_flow_seq_entry.num = 139;

    // [140]
    // c-flow-mapping(n,c) ::=
    //   '{' s-separate(n,c)?
    //   ns-s-flow-map-entries(n,in-flow(c))? '}'
    GrammarSpec.prototype.c_flow_mapping.num = 140;
    ...
    //   ( ',' s-separate(n,c)?
    //   ns-s-flow-map-entries(n,c)? )?
    GrammarSpec.prototype.ns_s_flow_map_entries.num = 141;
    ...
    GrammarSpec.prototype.ns_flow_map_entry.num = 142;
    ...
    //   | ( e-node
    //   e-node )
    GrammarSpec.prototype.ns_flow_map_explicit_entry.num = 143;
    ...
    GrammarSpec.prototype.ns_flow_map_implicit_entry.num = 144;
    ...
    //   | e-node )
    GrammarSpec.prototype.ns_flow_map_yaml_key_entry.num = 145;

    // [146]
    // c-ns-flow-map-empty-key-entry(n,c) ::=
    //   e-node
    //   c-ns-flow-map-separate-value(n,c)
    GrammarSpec.prototype.c_ns_flow_map_empty_key_entry.num = 146;
    ...
    //   | e-node )
    GrammarSpec.prototype.c_ns_flow_map_separate_value.num = 147;
    ...
    //   | e-node )
    GrammarSpec.prototype.c_ns_flow_map_json_key_entry.num = 148;
    ...
    //   ns-flow-node(n,c) )
    //   | e-node )
    GrammarSpec.prototype.c_ns_flow_map_adjacent_value.num = 149;
    ...
    GrammarSpec.prototype.ns_flow_pair.num = 150;
    ...
    GrammarSpec.prototype.ns_flow_pair_entry.num = 151;

    // [152]
    // ns-flow-pair-yaml-key-entry(n,c) ::=
    //   ns-s-implicit-yaml-key(flow-key)
    //   c-ns-flow-map-separate-value(n,c)
    GrammarSpec.prototype.ns_flow_pair_yaml_key_entry.num = 152;

    // [153]
    // c-ns-flow-pair-json-key-entry(n,c) ::=
    //   c-s-implicit-json-key(flow-key)
    //   c-ns-flow-map-adjacent-value(n,c)
    GrammarSpec.prototype.c_ns_flow_pair_json_key_entry.num = 153;
    ...
    GrammarSpec.prototype.ns_s_implicit_yaml_key.num = 154;
    ...
    //   s-separate-in-line?
    //   <at_most_1024_characters_altogether>
    GrammarSpec.prototype.c_s_implicit_json_key.num = 155;

    // [156]
    // ns-flow-yaml-content(n,c) ::=
    //   ns-plain(n,c)
    GrammarSpec.prototype.ns_flow_yaml_content.num = 156;

    // [157]
    // c-flow-json-content(n,c) ::=
    //   c-flow-sequence(n,c) | c-flow-mapping(n,c)
    //   | c-single-quoted(n,c) | c-double-quoted(n,c)
    GrammarSpec.prototype.c_flow_json_content.num = 157;

    // [158]
    // ns-flow-content(n,c) ::=
    //   ns-flow-yaml-content(n,c) | c-flow-json-content(n,c)
    GrammarSpec.prototype.ns_flow_content.num = 158;
    ...
    //   ns-flow-yaml-content(n,c) )
    //   | e-scalar ) )
    GrammarSpec.prototype.ns_flow_yaml_node.num = 159;
    ...
    //   s-separate(n,c) )?
    //   c-flow-json-content(n,c)
    GrammarSpec.prototype.c_flow_json_node.num = 160;
    ...
    //   ns-flow-content(n,c) )
    //   | e-scalar ) )
    GrammarSpec.prototype.ns_flow_node.num = 161;
    ...
    //   c-indentation-indicator(m) ) )
    //   s-b-comment
    GrammarSpec.prototype.c_b_block_header.num = 162;

    // [163]
    // c-indentation-indicator(m) ::=
    //   ( ns-dec-digit => m = ns-dec-digit - x:30 )
    //   ( <empty> => m = auto-detect() )
    GrammarSpec.prototype.c_indentation_indicator.num = 163;
    ...
    //   ( '+' => t = keep )
    //   ( <empty> => t = clip )
    GrammarSpec.prototype.c_chomping_indicator.num = 164;
    ...
    GrammarSpec.prototype.b_chomped_last.num = 165;
    ...
    GrammarSpec.prototype.l_chomped_empty.num = 166;

    // [167]
    // l-strip-empty(n) ::=
    //   ( s-indent(<=n) b-non-content )*
    //   l-trail-comments(n)?
    GrammarSpec.prototype.l_strip_empty.num = 167;

    // [168]
    // l-keep-empty(n) ::=
    //   l-empty(n,block-in)*
    //   l-trail-comments(n)?
    GrammarSpec.prototype.l_keep_empty.num = 168;
    ...
    //   l-comment*
    GrammarSpec.prototype.l_trail_comments.num = 169;

    // [170]
    // c-l+literal(n) ::=
    //   '|' c-b-block-header(m,t)
    //   l-literal-content(n+m,t)
    GrammarSpec.prototype.c_l_literal.num = 170;

    // [171]
    // l-nb-literal-text(n) ::=
    //   l-empty(n,block-in)*
    //   s-indent(n) nb-char+
    GrammarSpec.prototype.l_nb_literal_text.num = 171;

    // [172]
    // b-nb-literal-next(n) ::=
    //   b-as-line-feed
    //   l-nb-literal-text(n)
    GrammarSpec.prototype.b_nb_literal_next.num = 172;
    ...
    //   b-chomped-last(t) )?
    //   l-chomped-empty(n,t)
    GrammarSpec.prototype.l_literal_content.num = 173;

    // [174]
    // c-l+folded(n) ::=
    //   '>' c-b-block-header(m,t)
    //   l-folded-content(n+m,t)
    GrammarSpec.prototype.c_l_folded.num = 174;

    // [175]
    // s-nb-folded-text(n) ::=
    //   s-indent(n) ns-char
    //   nb-char*
    GrammarSpec.prototype.s_nb_folded_text.num = 175;

    // [176]
    // l-nb-folded-lines(n) ::=
    //   s-nb-folded-text(n)
    //   ( b-l-folded(n,block-in) s-nb-folded-text(n) )*
    GrammarSpec.prototype.l_nb_folded_lines.num = 176;

    // [177]
    // s-nb-spaced-text(n) ::=
    //   s-indent(n) s-white
    //   nb-char*
    GrammarSpec.prototype.s_nb_spaced_text.num = 177;

    // [178]
    // b-l-spaced(n) ::=
    //   b-as-line-feed
    //   l-empty(n,block-in)*
    GrammarSpec.prototype.b_l_spaced.num = 178;

    // [179]
    // l-nb-spaced-lines(n) ::=
    //   s-nb-spaced-text(n)
    //   ( b-l-spaced(n) s-nb-spaced-text(n) )*
    GrammarSpec.prototype.l_nb_spaced_lines.num = 179;

    // [180]
    // l-nb-same-lines(n) ::=
    //   l-empty(n,block-in)*
    //   ( l-nb-folded-lines(n) | l-nb-spaced-lines(n) )
    GrammarSpec.prototype.l_nb_same_lines.num = 180;

    // [181]
    // l-nb-diff-lines(n) ::=
    //   l-nb-same-lines(n)
    //   ( b-as-line-feed l-nb-same-lines(n) )*
    GrammarSpec.prototype.l_nb_diff_lines.num = 181;
    ...
    //   b-chomped-last(t) )?
    //   l-chomped-empty(n,t)
    GrammarSpec.prototype.l_folded_content.num = 182;
    ...
    GrammarSpec.prototype.l_block_sequence.num = 183;

    // [184]
    // c-l-block-seq-entry(n) ::=
    //   '-' <not_followed_by_an_ns-char>
    //   s-l+block-indented(n,block-in)
    GrammarSpec.prototype.c_l_block_seq_entry.num = 184;
    ...
    //   | s-l+block-node(n,c)
    //   | ( e-node s-l-comments )
    GrammarSpec.prototype.s_l_block_indented.num = 185;

    // [186]
    // ns-l-compact-sequence(n) ::=
    //   c-l-block-seq-entry(n)
    //   ( s-indent(n) c-l-block-seq-entry(n) )*
    GrammarSpec.prototype.ns_l_compact_sequence.num = 186;
    ...
    //   <for_some_fixed_auto-detected_m_>_0>
    GrammarSpec.prototype.l_block_mapping.num = 187;

    // [188]
    // ns-l-block-map-entry(n) ::=
    //   c-l-block-map-explicit-entry(n)
    //   | ns-l-block-map-implicit-entry(n)
    GrammarSpec.prototype.ns_l_block_map_entry.num = 188;
    ...
    //   | e-node )
    GrammarSpec.prototype.c_l_block_map_explicit_entry.num = 189;

    // [190]
    // c-l-block-map-explicit-key(n) ::=
    //   '?'
    //   s-l+block-indented(n,block-out)
    GrammarSpec.prototype.c_l_block_map_explicit_key.num = 190;

    // [191]
    // l-block-map-explicit-value(n) ::=
    //   s-indent(n)
    //   ':' s-l+block-indented(n,block-out)
    GrammarSpec.prototype.l_block_map_explicit_value.num = 191;
    ...
    GrammarSpec.prototype.ns_l_block_map_implicit_entry.num = 192;

    // [193]
    // ns-s-block-map-implicit-key ::=
    //   c-s-implicit-json-key(block-key)
    //   | ns-s-implicit-yaml-key(block-key)
    GrammarSpec.prototype.ns_s_block_map_implicit_key.num = 193;
    ...
    //   | ( e-node s-l-comments ) )
    GrammarSpec.prototype.c_l_block_map_implicit_value.num = 194;

    // [195]
    // ns-l-compact-mapping(n) ::=
    //   ns-l-block-map-entry(n)
    //   ( s-indent(n) ns-l-block-map-entry(n) )*
    GrammarSpec.prototype.ns_l_compact_mapping.num = 195;

    // [196]
    // s-l+block-node(n,c) ::=
    //   s-l+block-in-block(n,c) | s-l+flow-in-block(n)
    GrammarSpec.prototype.s_l_block_node.num = 196;

    // [197]
    // s-l+flow-in-block(n) ::=
    //   s-separate(n+1,flow-out)
    //   ns-flow-node(n+1,flow-out) s-l-comments
    GrammarSpec.prototype.s_l_flow_in_block.num = 197;

    // [198]
    // s-l+block-in-block(n,c) ::=
    //   s-l+block-scalar(n,c) | s-l+block-collection(n,c)
    GrammarSpec.prototype.s_l_block_in_block.num = 198;
    ...
    GrammarSpec.prototype.s_l_block_scalar.num = 199;
    ...
    //   | l+block-mapping(n) )
    GrammarSpec.prototype.s_l_block_collection.num = 200;

    // [201]
    // seq-spaces(n,c) ::=
    //   ( c = block-out => n-1 )
    //   ( c = block-in => n )
    GrammarSpec.prototype.seq_spaces.num = 201;

    // [202]
    // l-document-prefix ::=
    //   c-byte-order-mark? l-comment*
    GrammarSpec.prototype.l_document_prefix.num = 202;

    // [203]
    // c-directives-end ::=
    //   '-' '-' '-'
    GrammarSpec.prototype.c_directives_end.num = 203;

    // [204]
    // c-document-end ::=
    //   '.' '.' '.'
    GrammarSpec.prototype.c_document_end.num = 204;

    // [205]
    // l-document-suffix ::=
    //   c-document-end s-l-comments
    GrammarSpec.prototype.l_document_suffix.num = 205;
    ...
    GrammarSpec.prototype.c_forbidden.num = 206;

    // [207]
    // l-bare-document ::=
    //   s-l+block-node(-1,block-in)
    //   <excluding_c-forbidden_content>
    GrammarSpec.prototype.l_bare_document.num = 207;
    ...
    //   ( l-bare-document
    //   | ( e-node s-l-comments ) )
    GrammarSpec.prototype.l_explicit_document.num = 208;

    // [209]
    // l-directive-document ::=
    //   l-directive+
    //   l-explicit-document
    GrammarSpec.prototype.l_directive_document.num = 209;
    ...
    //   | l-explicit-document
    //   | l-bare-document
    GrammarSpec.prototype.l_any_document.num = 210;
    ...
    GrammarSpec.prototype.l_yaml_stream.num = 211;
